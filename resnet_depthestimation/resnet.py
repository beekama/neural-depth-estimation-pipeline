...
class ResNet(nn.Module):
    def __init__(
        ...
        #self.fc = nn.Conv2d(512*block.expansion, 1, kernel_size=1, stride=1, padding=0)
        self.final_upsample = nn.ConvTranspose2d(512 * block.expansion, 256, kernel_size=8, stride=4, padding=2, bias=False)
        ...
        self.upconv3 = nn.ConvTranspose2d(64, 1, kernel_size=4, stride=2, padding=1, bias=False)
