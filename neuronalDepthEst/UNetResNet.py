# UNet-code is based upon https://github.com/Henningson/SSSLsquared/blob/main/models/UNet.py

import torch
import torch.nn as nn
import torchvision.transforms.functional as TF

# code-block is based upon https://blog.paperspace.com/writing-resnet-from-scratch-in-pytorch/
class ResidualBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.proj_layer = nn.Conv2d(in_channels, out_channels, kernel_size=1, stride=stride, padding=0)
...
class Model(nn.Module):
    def __init__(self, config={'in_channels': 3, 'out_channels': 3, 'features': [64, 128, 256, 512]}, state_dict=None, pretrain=False, device="cuda"):
        ...
        self.bottleneck = ResidualBlock(features[-1], self.bottleneck_size)
